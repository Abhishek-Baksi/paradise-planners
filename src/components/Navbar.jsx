...
const Navbar = () => {
  ...
  return (
    <div className="absolute w-full flex justify-between p-4 items-center ">
      ...
      {/* <ul className="flex flex-row fixed w-full h-full justify-center items-center text-white 
       md:hidden z-100">
      ...
      {nav ? <HiOutlineXCircle onClick={handleNavBtn} size={25} className={`z-20 text-white cursor-pointer md:hidden`} /> : <HiMenuAlt3 onClick={handleNavBtn} size={25} className={`z-20 text-white cursor-pointer md:hidden`} />}
